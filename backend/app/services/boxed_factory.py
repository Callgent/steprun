...
class SessionFactory:
    ...
    async def create_session(self) -> tuple[str, str]:
        ...
        logger.info(
            f"Created session {session_id} with box {self.session_map[session_id]}"
        )
